...
<!-- V8_VERSION -->15.3.76.4<!-- /V8_VERSION -->). The libraries are **not** committed to the repository: they are published as checksum-verified GitHub Release assets and fetched on demand.
